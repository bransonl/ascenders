...
public class Login {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        sidebarTicket.click();
        wait.until(ExpectedConditions.elemntToBeClickable(By.name("addticket")));
        WebElement addTicket = driver.findElement(By.name("addticket"));
        addTicket.click();
        ...
        try {
            ...
            title.sendKeys("This be title");
            description.sendKeys("This be description");
            WebElement submit = driver.findElement(By.name("ticketSubmit"));
            submit.click();
        } catch (Exception NoSuchElementException) {
