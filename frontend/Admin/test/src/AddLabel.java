...
public class Login {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        WebElement sidebarTicket = driver.findElement(By.name("Tickets"));
        sidebarTicket.click();
        wait.until(ExpectedConditions.elemntToBeClickable(By.name("addlabel")));
        WebElement addTicket = driver.findElement(By.name("addlabel"));
        addTicket.click();

        try {
            WebElement labelname = driver.findElement(By.name("labelname"));
            WebElement color = driver.findElement(By.name("color"));

            labelname.sendKeys("aName");
            color.sendKeys("febc11");
            WebElement submit = driver.findElement(By.name("labelSubmit"));
            submit.click();
        } catch (Exception NoSuchElementException) {
